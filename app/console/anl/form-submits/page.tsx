...
export default function Page() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch('/api/analytics/data?tenant_id=' + unit.id + '&range=' + range + '&view=form_submits');
  ...
  return (
    <div>
      <ScreenHeader title="Form Submits" description="Lead and appointment form submission log" />
