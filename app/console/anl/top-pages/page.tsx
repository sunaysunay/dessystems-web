...
export default function Page() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch('/api/analytics/data?tenant_id=' + unit.id + '&range=' + range + '&view=top_pages');
  ...
  return (
    <div>
      <ScreenHeader title="Top Pages" description="Most visited pages ranked by views" />
