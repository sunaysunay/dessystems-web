...
export const OPS_SCREEN_OBJECTS: BopObject[] = [
  ...
  { object_id:"screen:OP001-kanban",type:"screen",module:"OPS",name:"Kanban Board",route:"/console/ops/tasks/kanban",status:"active",description:"Drag-to-transition kanban columns by status" },
  { object_id:"screen:OP001-calendar",type:"screen",module:"OPS",name:"Calendar View",route:"/console/ops/tasks/calendar",status:"active",description:"Tasks by due date — month and week views" },
...
export const OPS_API_OBJECTS: BopObject[] = [
  ...
  { object_id:"api:ops/tasks/templates:GET",type:"api",module:"OPS",name:"GET Task Templates",route:"/api/bop/ops/tasks/templates",status:"active" },
  { object_id:"api:ops/tasks/templates:POST",type:"api",module:"OPS",name:"Template Actions (create, add_step, instantiate)",route:"/api/bop/ops/tasks/templates",status:"active" },
  { object_id:"api:ops/tasks/triggers:GET",type:"api",module:"OPS",name:"GET Task Triggers",route:"/api/bop/ops/tasks/triggers",status:"active" },
  { object_id:"api:ops/tasks/triggers:POST",type:"api",module:"OPS",name:"Trigger Actions (create, fire, toggle)",route:"/api/bop/ops/tasks/triggers",status:"active" },
  { object_id:"api:ops/tasks/views:GET",type:"api",module:"OPS",name:"GET Saved Views",route:"/api/bop/ops/tasks/views",status:"active" },
  { object_id:"api:ops/tasks/views:POST",type:"api",module:"OPS",name:"View Actions (create, pin)",route:"/api/bop/ops/tasks/views",status:"active" },
];
...
export const OPS_TABLE_OBJECTS: BopObject[] = [
  ...
  { object_id:"table:op_task_templates",type:"table",module:"OPS",name:"op_task_templates",status:"active",description:"Reusable task templates — tenant-scoped, chain support, priority defaults" },
  { object_id:"table:op_task_template_steps",type:"table",module:"OPS",name:"op_task_template_steps",status:"active",description:"Template steps — ordered, SLA offsets, dependency chaining" },
  { object_id:"table:op_task_triggers",type:"table",module:"OPS",name:"op_task_triggers",status:"active",description:"Event-driven task triggers — event_type to template mapping, cooldown" },
  { object_id:"table:op_task_trigger_events",type:"table",module:"OPS",name:"op_task_trigger_events",status:"active",description:"Trigger execution log — idempotency, created task IDs" },
  { object_id:"table:op_task_views",type:"table",module:"OPS",name:"op_task_views",status:"active",description:"Saved filter views — pinnable, per-user, sort config" },
];
...
export const OPS_DEPENDENCIES: BopDependency[] = [
  ...
  { from_id:"screen:OP001-kanban",to_id:"api:ops/tasks:GET",dep_type:"calls" },
  { from_id:"screen:OP001-kanban",to_id:"api:ops/tasks:POST",dep_type:"calls" },
  { from_id:"screen:OP001-calendar",to_id:"api:ops/tasks:GET",dep_type:"calls" },
  { from_id:"api:ops/tasks/templates:GET",to_id:"table:op_task_templates",dep_type:"reads" },
  { from_id:"api:ops/tasks/templates:GET",to_id:"table:op_task_template_steps",dep_type:"reads" },
  { from_id:"api:ops/tasks/templates:POST",to_id:"table:op_task_templates",dep_type:"writes" },
  { from_id:"api:ops/tasks/templates:POST",to_id:"table:op_task_template_steps",dep_type:"writes" },
  { from_id:"api:ops/tasks/templates:POST",to_id:"table:op_tasks",dep_type:"writes" },
  { from_id:"api:ops/tasks/triggers:GET",to_id:"table:op_task_triggers",dep_type:"reads" },
  { from_id:"api:ops/tasks/triggers:POST",to_id:"table:op_task_triggers",dep_type:"writes" },
  { from_id:"api:ops/tasks/triggers:POST",to_id:"table:op_task_trigger_events",dep_type:"writes" },
  { from_id:"api:ops/tasks/triggers:POST",to_id:"table:op_tasks",dep_type:"writes" },
  { from_id:"api:ops/tasks/views:GET",to_id:"table:op_task_views",dep_type:"reads" },
  { from_id:"api:ops/tasks/views:POST",to_id:"table:op_task_views",dep_type:"writes" },
];
