...
export default function Page() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch('/api/analytics/data?tenant_id=' + unit.id + '&range=' + range + '&view=not_found');
  ...
  return (
    <div>
      <ScreenHeader title="404 Errors" description="Not-found page errors and broken links" />
