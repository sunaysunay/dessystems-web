...
function makeNav(tn: (k: string) => string, tg: (k: string) => string): NavSection[] {
  ...
  { group: tg('workshop'), items: [
    { label: tn('wrkDashboard'),        href: '/console/wrk/dashboard' },
    { label: tn('wrkOrders'),           href: '/console/wrk/orders' },
    { label: tn('wrkPlanning'),         href: '/console/wrk/planning' },
    { label: tn('wrkEfficiency'),       href: '/console/wrk/efficiency' },
    { label: tn('wrkInspections'),      href: '/console/wrk/inspections' },
    { label: tn('wrkApkReminders'),     href: '/console/wrk/apk-reminders' },
    { label: tn('wrkApprovals'),        href: '/console/wrk/approvals' },
    { label: tn('wrkCustomerStatus'),   href: '/console/wrk/status' },
    { label: tn('wrkBriefing'),         href: '/console/wrk/briefing' },
    ...
    { label: tn('shopProducts'), href: '/console/shp/products',
      subgroups: [
        ...
        { subgroup: tg('shopAnalyticsGrp'), items: [
          { label: tn('shopAnalyticsOverview'),  href: '/console/shp/analytics/overview' },
          { label: tn('shopAnalyticsFunnel'),    href: '/console/shp/analytics/funnel' },
          { label: tn('shopAnalyticsSales'),     href: '/console/shp/analytics/sales' },
          { label: tn('shopAnalyticsProducts'),  href: '/console/shp/analytics/products' },
          { label: tn('shopAnalyticsCustomers'), href: '/console/shp/analytics/customers' },
          { label: tn('shopAnalyticsTraffic'),   href: '/console/shp/analytics/traffic' },
          { label: tn('shopAnalyticsCheckout'),  href: '/console/shp/analytics/checkout' },
